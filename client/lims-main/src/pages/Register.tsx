...
import { Mail, Lock, User, Phone, School, HelpCircle, Globe, BookOpen } from 'lucide-react';
      ...
      <main className="w-full max-w-5xl bg-white shadow-xl flex flex-col md:flex-row overflow-hidden border border-outline-variant rounded-xl">
        ...
        <div className="hidden md:flex md:w-1/2 relative bg-primary overflow-hidden items-center justify-center p-stack_lg">
          ...
          <div className="relative z-10 text-center">
            ...
            <h1 className="headline-lg text-white mb-stack_sm">Create Account</h1>
            <p className="text-on-primary-container body-md max-w-xs mx-auto">Join our academic community and manage your resources effortlessly.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col p-8 md:p-12 bg-white overflow-y-auto">
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-secondary font-bold text-sm tracking-widest uppercase">Institutional Access</span>
            </div>
            <h2 className="headline-lg text-primary mb-6">Register</h2>
            
            <div className="flex border-b border-outline-variant mb-stack_lg">
              <Link to="/login" className="px-6 py-2 border-b-2 border-transparent text-outline hover:text-primary font-medium body-md transition-colors">Login</Link>
              <button className="px-6 py-2 border-b-2 border-secondary text-secondary font-semibold body-md transition-colors">Register</button>
            </div>
          </div>

          <form className="space-y-stack_md" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-1">
              <label className="label-sm text-on-surface-variant block">Full Name</label>
            ...
            <div className="space-y-1">
              <label className="label-sm text-on-surface-variant block">Institutional Email</label>
              <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="label-sm text-on-surface-variant block">Contact</label>
                <div className="relative">
              ...
              <div className="space-y-1">
                <label className="label-sm text-on-surface-variant block">Role</label>
                <div className="relative">
            ...
            <div className="space-y-1">
              <label className="label-sm text-on-surface-variant block">Password</label>
              <div className="relative">

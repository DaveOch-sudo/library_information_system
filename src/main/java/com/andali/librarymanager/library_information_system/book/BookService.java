...
public class BookService {
        ...
        private BookDTO mapToBookDTO(Book book) {
                return BookDTO.builder()
                                ...
                                .pdfFilePath(book.getPdfFilePath() != null ? book.getPdfFilePath() : "")
                                .hasEbook(book.getHasEbook() != null ? book.getHasEbook() : false)
                                .build();
        }
        ...
        public boolean canUserAccessBook(Long bookId, Long userId) {
                // Check if user has an approved reservation for this book
                List<Reservation> reservations = reservationRepository.findByUserIdAndBookId(userId, bookId);
                return reservations.stream()
                                .anyMatch(r -> r.getStatus() == Reservation.Status.APPROVED ||
                                                r.getStatus() == Reservation.Status.FULFILLED);
        }
}
